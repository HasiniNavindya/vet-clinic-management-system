    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative pt-20 pb-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-white mb-4 sm:mb-6">Pet Care Blog</h1>
      ...
      {featuredPost && (
        <section className="py-4 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-gray-900 mb-6 sm:mb-8 flex items-center gap-2">
              ...
              {otherPosts.map((post) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-gray-900 mb-2 line-clamp-2 group-hover:text-[#ec6d13] transition-colors">
                      {post.title}
                    </h3>
