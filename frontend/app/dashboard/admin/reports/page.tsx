  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto max-w-3xl px-4 py-8 pt-28">
        ...
        <h1 className="mt-2 text-2xl font-bold text-gray-900">Monthly reports</h1>
          ...
          <div className="mt-8 space-y-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <dl className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <dd className="mt-1 text-xs text-gray-500">Appointment rows created in this month.</dd>
              </div>
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <dd className="mt-1 text-xs text-gray-500">Scheduled date fell in this month.</dd>
              </div>
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <dd className="mt-1 text-xs text-gray-500">Medical record visit dates in this month.</dd>
              </div>
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <dd className="mt-1 text-xs text-gray-500">Successful transactions with paid timestamps.</dd>
              </div>
