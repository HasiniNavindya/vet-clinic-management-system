...
export default function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  return (
    ...
    >
      ...
      {/* Modal Content */}
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full animate-slide-in-up">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#ec6d13] text-white py-3 rounded-lg font-semibold text-base hover:bg-[#d65e0f] focus:outline-none focus:ring-4 focus:ring-[#ec6d13]/30 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
